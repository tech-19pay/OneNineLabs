...
export const servicePageStyles = (primaryColor = "#2563eb", gradFrom = "#1e3a8a", gradTo = "#2563eb", glowRgba = "rgba(37,99,235,0.3)") => `
  ...
  /* ── BROWSER MOCKUP FRAME (HERO RIGHT COLUMN) ── */
  .sh-mockup-wrapper {
    position: relative;
    width: 100%;
    max-width: 520px;
  ...
  .sh-mockup-glow {
    position: absolute;
    inset: 10px;
    background: radial-gradient(circle at 50% 50%, ${glowRgba.replace('0.3', '0.25')}, transparent 70%);
    filter: blur(40px);
    pointer-events: none;
    z-index: 1;
  }
  .sh-browser-mockup {
    ...
    border-radius: 20px;
    border: 1.5px solid #e2e8f0;
    box-shadow: 0 25px 60px rgba(15, 23, 42, 0.12), 0 0 1px rgba(15, 23, 42, 0.15);
    overflow: hidden;
    transition: transform 0.4s cubic-bezier(0.16, 1, 0.3, 1), box-shadow 0.4s ease;
  }
  .sh-browser-mockup:hover {
    transform: translateY(-4px);
    box-shadow: 0 35px 80px rgba(15, 23, 42, 0.18), 0 0 40px ${glowRgba.replace('0.3', '0.2')};
    border-color: #cbd5e1;
  }
  .sh-browser-header {
    background: #f8fafc;
  ...
  .sh-dot-yellow { background: #f59e0b; }
  .sh-dot-green { background: #10b981; }
  .sh-browser-address-bar {
    flex: 1;
    max-width: 240px;
    background: #ffffff;
  ...
  .sh-browser-mockup:hover .sh-browser-img {
  ...
  .sh-mockup-float-badge.top-right {
    top: -12px;
    right: -14px;
    font-size: 11.5px;
    padding: 7px 14px;
  ...
  .sh-mockup-float-badge.bottom-left {
    bottom: -14px;
    left: -14px;
    animation-delay: 2s;
  }
  ...
  .vd-marquee-section { background: #fdf8f0; padding: 26px 0; border-bottom: 1px solid #f0e6d6; overflow: hidden; }
  .vd-marquee-track {
  ...
  .vd-welcome-section { background: #fdf8f0; padding: 110px 24px 96px; border-bottom: 1px solid #f0e6d6; }
  .vd-welcome-grid {
  ...
  /* ── ALTERNATING ARCH-CARD PILL ROWS UI (MATCHING LANGUAGES & ENVIRONMENTS SECTION) ── */
  .sas-section {
  ...
  .sas-header .vd-badge-tag {
    margin: 0 auto 14px;
    color: ${primaryColor};
    background: ${glowRgba.replace('0.3', '0.1')};
    border: 1px solid ${glowRgba.replace('0.3', '0.25')};
  }
  .sas-header .vd-section-h2 {
    color: #0f172a !important;
    text-shadow: none !important;
  }
  .sas-header .vd-section-p {
  ...
  .vd-process-section { background: #fdf8f0; padding: 90px 24px 40px; border-bottom: none; text-align: center; }
  ...
  /* ── 7. PRICING PLANS ── */
  .vd-pricing-section { background: #fdf8f0; padding: 40px 24px 40px; border-bottom: none; text-align: center; }
  ...
  /* ── 9. FAQ ── */
  .vd-faq-section { background: #fdf8f0; padding: 0px 24px 20px; border-bottom: 1px solid #f0e6d6; text-align: center; }
  ...
  @media (max-width: 768px) {
    ...
    .ws-grid { grid-template-columns: 1fr !important; gap: 14px; }
    ...
    /* ── Hero Section Mobile ── */
    .sh-section {
      padding: calc(var(--header-height, 80px) + 24px) 16px 30px !important;
    }
    .sh-hero-box {
      grid-template-columns: 1fr !important;
      gap: 32px;
