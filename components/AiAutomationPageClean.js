...
export default function AiAutomationPageClean() {
  return (
    <div className="vd-wrap" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <section style={{
        ...
        <div className="aic-hero-grid" style={{ maxWidth: "1280px", margin: "0 auto", display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: "56px", alignItems: "center" }}>
          ...
          <div style={{ textAlign: "left", zIndex: 2 }}>
            ...
            <div className="aic-hero-btns" style={{ display: "flex", gap: "16px", flexWrap: "wrap", marginBottom: "48px" }}>
            ...
            <div className="aic-checks-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", maxWidth: "600px" }}>
      ...
      <section style={{ background: "#ffffff", padding: "40px 24px 40px 24px", borderBottom: "1px solid #f1f5f9" }}>
        <div style={{ maxWidth: "1150px", margin: "0 auto" }}>
      ...
      {/* ═══ 11. CTA ═══ */}
      <section className="vd-cta-section" id="get-started" style={{ paddingTop: "0px", marginTop: "-20px" }}>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          .aic-checks-grid { grid-template-columns: 1fr !important; }
          .aic-hero-btns { flex-direction: column; }
          .aic-hero-btns a { width: 100%; text-align: center; justify-content: center; }
          .aic-float-chip, .aic-float-chip2 { display: none !important; }
        }
      `}</style>
    </div>
  );
