...
export const metadata = {
  ...
  openGraph: { locale: "en_US", siteName: "OneNineLabs", title: "Growth Marketing, SEO & PPC — 4.8x ROAS | OneNineLabs", description: "Technical SEO + PPC + CRO + full-funnel analytics — engineered for compounding growth.", url: "https://oneninelabs.com/services/marketing", type: "website", images: [
      { url: "/og/marketing.jpg", width: 1200, height: 630, alt: "Growth Marketing by OneNineLabs", type: "image/jpeg" },
    ] },
  twitter: { site: "@oneninelabs", creator: "@oneninelabs", card: "summary_large_image", title: "Growth Marketing, SEO & PPC — 4.8x ROAS | OneNineLabs", description: "Technical SEO + PPC + CRO that compounds.", images: ["/og/marketing.jpg"] },
      ...
      <div className="vd-wrap">
        ...
        <section className="vd-results-section" style={{ paddingTop: "30px" }}>
          ...
          <div className="outcomes-bento-grid">
            ...
            {/* Card 4: Bottom Wide */}
            <div className="outcomes-bento-item ob-wide" style={{ flexDirection: "row", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
